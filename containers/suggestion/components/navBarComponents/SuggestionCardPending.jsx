...
const SuggestionCardPending = (props) => {
                            ...
                            {props.user && props.user.role === "ADMIN" ?
                                <React.Fragment>
                                    <ModalReasonComponent
                                        ...
                                        classNameProp={"push_simple orange"}
                                    ></ModalReasonComponent>
                                </React.Fragment>
                                : null
                            }
                            ...
                            <div className="column column2-card">
                                ...
                                <p className="suggestion-text">{props.suggestion.text}</p>
                                {
                                    props.user.role === 'ADMIN' ?
                                        (
                                            <p>
                                                <button id={"accept" + props.suggestion.id} className="push_button grey" onClick={() => props.accept(props.suggestion.id)} >Accept</button>
...
export default SuggestionCardPending;