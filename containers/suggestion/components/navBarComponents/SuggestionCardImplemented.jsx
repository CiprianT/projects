...
const SuggestionCardImplemented = (props) => {
    return (
                            ...
                            {props.user && props.user.role==="ADMIN"?
                             <React.Fragment>
                                  <ModalReasonComponent
                                     title={props.suggestion.title} id={props.suggestion.id} status ={ESugestionStatus.IMPLEMENTED} declined={false}
                                 ></ModalReasonComponent>
                             </React.Fragment>         
                             :null
                            }     
...
export default SuggestionCardImplemented;