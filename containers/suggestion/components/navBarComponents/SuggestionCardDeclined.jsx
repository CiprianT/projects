...
const SuggestionCardDeclined = (props) => {
    return (
                            ...
                            {props.user && props.user.role==="ADMIN"?
                             ...
                             <React.Fragment>
                                  <ModalReasonComponent
                                     title={props.suggestion.title} id={props.suggestion.id} status = {ESugestionStatus.DECLINED} declined={false}
                                 ></ModalReasonComponent>
                             </React.Fragment>         
                             :null
                            }   
...
export default SuggestionCardDeclined;